                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="input-states">
                            <form class="form-horizontal" method="POST" id="submitUserForm" action="php_action/agregarperiod.php?rol=<?php echo $idRol;?>&id=<?php  echo $_SESSION['userId'];?>" enctype="multipart/form-data">
