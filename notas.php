        ...
        <div class="row">
            <div class="col-lg-8" style=" margin-left: 10%;">
                <div class="card">
                 ...
                 <form class="form-horizontal" method="POST" id="submitUserForm" action="php_action/agregarnota.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input style="border: 2px solid #000;" required type="text" size=40 width=200px height=15px name="uemail" id="uemail" class="form-control" placeholder="Escriba su nota aquí">
                                        </div>
                                    </div>
                                </div>
