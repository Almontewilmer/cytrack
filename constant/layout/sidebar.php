     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <li> <a href="grafica.php" aria-expanded="false"><i class="fa fa-bar-chart"></i> Grafica</a>
                 <li> <a href="ajustes.php" aria-expanded="false"><i class="fa fa-wrench"></i> Ajustes</a>
                 <li> <a href="notas.php" aria-expanded="false"><i class="fa fa-pencil"></i> Notas</a>
