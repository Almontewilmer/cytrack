                        ...
                        <div class="media widget-ten">
                            ...
                            <a href="#">
                                ...
                                if (ceil($iniovu+(($fechadia+$diaspromedio))+1+5) > 30){
                                  ...
                                  echo 'Desde el dia', ' ', ceil((((($fechadia+$diaspromedio)*$fechadia)/$diaspromedio-$nouno)/$diaspromedio)/$diaspromedio), ' ', 'hasta el dia', ' ', ceil((((($fechadia+$diaspromedio)*$fechadia)/$diaspromedio-$nouno)/$diaspromedio)/$diaspromedio)+10;
                                
                                }
                                else{
                                  echo 'Desde el dia', ' ', ceil($iniovu+(($fechadia+$diaspromedio)-1+1)+4), ' ', 'hasta el dia', ' ', ceil($iniovu+(($fechadia+$diaspromedio))+1+5);
                        ...
                        <div class="media widget-ten">
                            ...
                            <a href="#">
                                ...
                                <h3 class="color-white"><?php
                                 $fechacompleta =  htmlentities($row['ultimop']);
                                $fechacompleta2 = strtotime($fechacompleta);
                                $fechadia =  idate('m', $fechacompleta2);
                                if ((ceil($fechadia + 30)) >= 30){
                                    $fechareal = ($fechadia + 30)-30;

                                    $mes_siguiente = $fechadia+1;
                                    if($mes_siguiente > 12)
                                    {
                                        $mes_siguiente = 'Enero';
                                    }
                                    else if ($mes_siguiente=='12'){
                                        $mes_siguiente = 'Diciembre';
                                    }
                                    else if ($mes_siguiente=='10'){
                                        $mes_siguiente = 'Octubre';
                                    }else if ($mes_siguiente=='11'){
                                        $mes_siguiente = 'Noviembre';
                                    }

                                    else if ($mes_siguiente=='9'){
                                        $mes_siguiente = 'Septiembre';
                                    }

                                    else if ($mes_siguiente=='8'){
                                        $mes_siguiente = 'Agosto';
                                    }

                                    else if ($mes_siguiente=='7'){
                                        $mes_siguiente = 'Julio';
                                    }

                                    else if ($mes_siguiente=='6'){
                                        $mes_siguiente = 'Junio';
                                    }

                                    else if ($mes_siguiente=='5'){
                                        $mes_siguiente = 'Mayo';
                                    }

                                    else if ($mes_siguiente=='4'){
                                        $mes_siguiente = 'Abril';
                                    }

                                    else if ($mes_siguiente=='2'){
                                        $mes_siguiente = 'Febrero';
                                    }

                                    else if ($mes_siguiente=='1'){
                                        $mes_siguiente = 'Enero';
                                    }
                                    else if ($mes_siguiente=='3'){
                                        $mes_siguiente = 'Marzo';
                                    }
